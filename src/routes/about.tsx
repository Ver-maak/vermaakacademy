...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Our mission to empower African creatives with future-ready digital skills, mentorship and community." },
      ...
      <section className="pb-20">
        <div className="mx-auto max-w-7xl px-5 lg:px-8 grid md:grid-cols-2 gap-6">
          {[
            ...
            <article key={b.label} className="p-8 rounded-3xl bg-card border border-border/60 soft-shadow">
      ...
      <section className="py-24">
        <div className="mx-auto max-w-4xl px-5 lg:px-8 text-center">
          ...
          <div className="mt-8 flex flex-wrap gap-3 justify-center">
            <Button asChild size="lg" variant="brand"><Link to="/courses">Explore Courses</Link></Button>
